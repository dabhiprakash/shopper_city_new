                                ...
                                <div class="tab tab-nav-simple tab-nav-boxed form-tab">
                                    ...
                                    <div class="tab-content ">
                                        <div class="tab-pane active" id="signin">
											...
											<a href="#" id="PayNow" class="btn btn-rounded btn-blue btn-block btn-gradient d-flex align-items-center justify-content-center">Buy Now...</a>
                                        </div>
                                    </div>
                                </div>
                            </div>
        ...
        <script>
            ...
            jQuery(document).ready(function ($) {
                jQuery("#PayNow").click(function (e) {
                    ...
                    var shipping_name = "<?php echo $_SESSION['first_name']; echo  $_SESSION['last_name']; ?>";
